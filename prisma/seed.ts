...
async function main() {
  ...
  // Create sample weekly menu for current week
  const now = new Date();
  ...
  console.log(`✅ Weekly menu created: Week ${weekNumber}, ${year}`);
  ...
  console.log(`✅ Created ${dayMenus.length} day menus`);
  ...
  // Create categories and items for each day
  ...
  console.log('✅ Sample menu data created successfully!');
  console.log('\n🎉 Seeding completed!');
}
